  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0">
            ...
            <div className="w-full sm:w-auto sm:flex-1 sm:max-w-md sm:mx-8 order-3 sm:order-none">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Search products..."
                  className="w-full pl-4 pr-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-gray-700 placeholder-gray-400 text-sm sm:text-base"
                />
              </div>
            </div>
            
            {/* Right side: Account, Share */}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        <div className="space-y-4 sm:space-y-6 lg:space-y-8 mb-16 sm:mb-20">
        ...
        <div className="text-center px-4">
          ...
          <button className="w-full sm:w-auto bg-gray-100 text-gray-800 font-medium py-3 sm:py-4 px-6 sm:px-8 rounded-lg hover:bg-gray-200 transition-colors duration-200 text-sm sm:text-base">
            Get Started Today
          </button>
        </div>
      </main>
